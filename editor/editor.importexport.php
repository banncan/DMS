...
class PLImportExport{
	...
	function export_template(){
		...
		<label class="checklist-label media <?php echo (!$publish_active) ? 'disabled': '';?>" for="publish_config">
			...
			<div class="bd">
				<div class="ttl"><?php echo (!$publish_active) ? _e( '(Disabled! No child theme active)', 'pagelines' ): '';?> <?php _e( 'Publish Configuration to Child Theme (No Download File)', 'pagelines' ); ?>
				</div>
